...
, COUNT(DISTINCT CASE WHEN LENGTH(TRIM(PRODUCT_NAME))<>0 THEN CUSTOMER_ID ELSE 0 END) TOTAL_DISTINTOS_PRODUCT_NAME
...
, COUNT(DISTINCT CASE WHEN LENGTH(TRIM(END_DATE))<>0 THEN END_DATE ELSE 0 END) TOTAL_END_DATE
